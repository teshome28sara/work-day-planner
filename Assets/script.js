...
//function to check each hour block and  see if hour block is the assigned color. ppast, gray, present, red, or future, green.
...
// When saveBtn is clicked, save items in  local storage
